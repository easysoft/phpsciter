...
inline void destroy_vm(HVM vm)
{
    ni()->destroy_vm(vm);
}

// set stdin, stdout and stderr for this VM
inline void  set_std_streams(HVM vm, stream* input, stream* output, stream* error)
{
    ni()->set_std_streams(vm, input, output, error);
}

inline HVM   get_current_vm()
{
    return ni()->get_current_vm();
}
inline value get_global_ns(HVM vm)
{
    return ni()->get_global_ns(vm);
}
inline value get_current_ns(HVM vm)
{
    return ni()->get_current_ns(vm);
}
inline void  invoke_gc(HVM vm)
{
    ni()->invoke_gc(vm);
}
...
struct runtime
{
    ...
    operator HVM()
    {
        return vm;    // so runtime reference can be used in places where HVM is required
    }

    value global_ns()
    {
        assert(vm);
        return get_global_ns(vm);
    }
    value current_ns()
    {
        assert(vm);
        return get_current_ns(vm);
    }
    void  run_gc()
    {
        assert(vm);
...
{
    return ni()->is_float(v);
}
inline bool  is_symbol(value v)
{
    return ni()->is_symbol(v);
}
inline bool  is_string(value v)
{
    return ni()->is_string(v);
}
inline bool  is_array(value v)
{
    return ni()->is_array(v);
}
inline bool  is_object(value v)
{
    return ni()->is_object(v);
}
inline bool  is_native_object(value v)
{
    return ni()->is_native_object(v);
}
inline bool  is_function(value v)
{
    return ni()->is_function(v);
}
inline bool  is_native_function(value v)
{
    return ni()->is_native_function(v);
}
inline bool  is_instance_of(value v, value cls)
{
    return ni()->is_instance_of(v,cls);
}
inline bool  is_undefined(value v)
{
    return ni()->is_undefined(v);
}
inline bool  is_nothing(value v)
{
    return ni()->is_nothing(v);
}
...
{
    return ni()->is_false(v);
}
inline bool  is_bool(value v)
{
    return is_true(v) || is_false(v);
}
inline bool  is_class(HVM vm,value v)
{
    return ni()->is_class(vm,v);
}
inline bool  is_error(value v)
{
    return ni()->is_error(v);
}
inline bool  is_bytes(value v)
{
    return ni()->is_bytes(v);
}

// to C/C++ type from the value
inline int          c_int(value v)
{
    int dv = 0;
    ni()->get_int_value(v,&dv);
    return dv;
}
inline double       c_float(value v)
{
    double dv = 0;
    ni()->get_float_value(v,&dv);
    return dv;
}
inline bool         c_bool(value v)
{
    bool dv = false;
    ni()->get_bool_value(v,&dv);
    return dv;
}
inline std::ustring c_symbol(value v)
{
    const WCHAR* dv = WSTR("");
    ni()->get_symbol_value(v,&dv);
    return dv;
}
inline std::ustring c_string(value v)
{
    const WCHAR* dv = WSTR("");
    unsigned len = 0;
    ni()->get_string_value(v,&dv,&len);
    return std::ustring(dv,len);
}
inline bool         c_bytes(value v, unsigned char* &data, unsigned &datalen)
{
    return ni()->get_bytes(v,&data,&datalen);
}

// to script value from C/C++ type
inline value        v_nothing()
{
    static value _v = ni()->nothing_value();    // designates ultimate "does not exist" situation.
    return _v;
}
inline value        v_undefined()
{
    static value _v = ni()->undefined_value();    // non-initialized or non-existent value
    return _v;
}
inline value        v_null()
{
    static value _v = ni()->null_value();    // explicit "no object" value
    return _v;
}
inline value        v_bool(bool v)
{
    return ni()->bool_value(v);
}
inline value        v_int(int v)
{
    return ni()->int_value(v);
}
inline value        v_float(double v)
{
    return ni()->float_value(v);
}
inline value        v_symbol(const char* v)
{
    return ni()->symbol_value(v);    // symbol is an int - perfect hash value of the string
}
...
inline value        v_string(HVM vm, const WCHAR* str, unsigned len = 0)
{
    return ni()->string_value(vm,str,len);
}
// the string of course.
inline value        v_string(const WCHAR* str, unsigned len = 0)
{
    HVM vm = get_current_vm();
    assert(vm);
    return v_string(vm,str,len);
}
// the string of course.

inline value        v_bytes(HVM vm, const unsigned char* data, unsigned datalen)
{
    return ni()->bytes_value(vm,data,datalen);
}
// make instance of Bytes object in script -
// sequence of bytes.
// Be notified: Bytes is a citizen of GCable heap. Use pinned thing to hold it
inline value        v_bytes(const unsigned char* data, unsigned datalen)
{
    HVM vm = get_current_vm();
    assert(vm);
...
inline std::ustring to_string(HVM vm,value v)
{
    return c_string(ni()->to_string(vm,v));
}
inline std::ustring to_string(value v)
{
    HVM vm = get_current_vm();
    assert(vm);
...
inline value        value_by_path(HVM vm, const char* path)
{
    value r = v_undefined();
    ni()->get_value_by_path(vm, &r, path);
    return r;
}
inline value        value_by_path(const char* path)
{
    HVM vm = get_current_vm();
    assert(vm);
    value r = v_undefined();
...
inline value  create_object(HVM vm, value of_class = 0)
{
    return ni()->create_object(vm, of_class);
}
inline value  create_object(HVM vm, const char* class_path )
{
    value cls = value_by_path(vm, class_path);
    assert( is_class(vm,cls) );
    return ni()->create_object(vm, cls);
}

// object propery access.
inline bool  set_prop(HVM vm, value obj, value key, value value)
{
    return ni()->set_prop(vm,obj,key,value);
}
inline value get_prop(HVM vm, value obj, value key)
{
    return ni()->get_prop(vm,obj,key);
}

inline bool  set_prop(HVM vm, value obj, const char* key, value value)
{
    return set_prop(vm,obj,v_symbol(key),value);
}
inline value get_prop(HVM vm, value obj, const char* key)
{
    return get_prop(vm,obj,v_symbol(key));
}

// get/set users data associated with instance of native object
inline void* get_native_data( value obj )
{
    assert(is_native_object(obj));
    return ni()->get_instance_data(obj);
}
inline void  set_native_data( value obj, void* data )
{
    assert(is_native_object(obj));
    ni()->set_instance_data(obj,data);
}

//@region Array

inline value     create_array(HVM vm, unsigned of_size)
{
    return ni()->create_array(vm,of_size);
}
inline bool      set_elem(HVM vm, value arr, unsigned idx, value val)
{
    return ni()->set_elem(vm,arr,idx,val);
}
inline value     get_elem(HVM vm, value arr, unsigned idx)
{
    return ni()->get_elem(vm,arr,idx);
}
inline unsigned  get_length(HVM vm, value arr)
{
    return ni()->get_array_size(vm,arr);
}
// reallocates the array and returns reallocated (if needed) array
inline value     set_length(HVM vm, value arr, unsigned of_size)
{
    return ni()->set_array_size(vm,arr,of_size);
}

// informs VM that native method got an error condition. Native method should return from the function after the call.
inline void      throw_error( HVM vm, const WCHAR* error_text)
{
    ni()->throw_error( vm, error_text );
}
inline void      throw_error( HVM vm, const std::basic_string<WCHAR> error_text)
{
    ni()->throw_error( vm, error_text.c_str() );
}
...
inline value     eval(HVM vm, stream& input, bool template_mode = false)
{
    return eval( vm, get_current_ns(vm), &input, template_mode);
}
...
inline value     eval(HVM vm, const WCHAR* text)
{
    return eval( vm, get_current_ns(vm), text);
}
...
inline value     call(HVM vm, value function, const value* argv = 0, unsigned argn = 0)
{
...
public:
    ...
    object_ref(HVM c,value obj):pinned(c)
    {
        assign(obj);
    }

    // create new object [of class]
    void create(value of_class = 0)
    {
        val = ni()->create_object(get_vm(), of_class);
    }
    void create(const char* class_path )
    {
        value cls = value_by_path(get_vm(), class_path);
        assert( is_class(vm,cls) );
    ...
    int length()
    {
        return (val && vm) ? ni()->get_length(vm,val) : 0;
    }
    ...
    {
        assert(is_set());
        return ni()->get_prop(vm,val,key);
    }
    bool  set(value key, value value)
    {
        assert(is_set());
        return ni()->set_prop(vm,val,key,value);
    }
    ...
    {
        assert(is_set());
        return ni()->set_prop(vm,val,v_symbol(key),value);
    }
    value get(const char* key)
    {
        assert(is_set());
        return ni()->get_prop(vm,val,v_symbol(key));
    }

    // var v = obj["key"]; obj["key"] = v;
    bool  set(const WCHAR* key, value v)
    {
        assert(is_set());
        pinned pv(get_vm(),v);
        value k = v_string(get_vm(),key);
        return ni()->set_prop(vm,val,k,pv);
    }
    value get(const WCHAR* key)
    {
        assert(is_set());
        value k = v_string(get_vm(),key);
        return ni()->get_prop(vm,val,k);
    }
    ...
    {
        assert(is_set());
        return static_cast<NDT>(get_native_data(val));
    }
    template <typename NDT>
    void data(NDT ptr)
    {
        assert(is_set());
        return set_native_data(val,static_cast<void*>(ptr));
    }
...
private:
    ...
    {
        val = v;
        assert( is_object(v) || is_native_object(v) );
    }
...
public:
    ...
    array_ref(HVM c,value obj):pinned(c)
    {
        assign(obj);
    }
    operator value()
    ...
    // create new array
    void create(unsigned num_elements = 0)
    {
        val = ni()->create_array(get_vm(), num_elements);
    }

    // accessors
    unsigned length()
    {
        return (val && vm)? (unsigned)ni()->get_length(vm,val) : 0;
    }
    ...
    {
        assert(is_set());
        return ni()->get_elem(vm,val,i);
    }
    bool  set(unsigned i, value value)
    {
        assert(is_set());
        return ni()->set_elem(vm,val,i, value);
    }
    // arr.push(v);
...
public:
    ...
    bool operator()(value& key, value& val)
    {
        return ni()->get_next_key_value(vm,&col,&pos,&key,&val);
    }
    bool operator()(value& val)
    {
        return ni()->get_next(vm,&col,&pos,&val);
    }
};
...
public:
    ...
    value get(int pn) const
    {
        return ni()->get_arg_n(vm,pn);
    }
    ...
    args& operator >> (bool& v)
    {
        if( opt && (n >= argc) ) return *this;
        if(!ni()->get_bool_value(get(n),&v)) throw error(n,"boolean");
        n++;
        return *this;
    }
    args& operator >> (int& v)
    {
        if( opt && (n >= argc) ) return *this;
        if(!ni()->get_int_value(get(n),&v)) throw error(n,"integer");
        n++;
        return *this;
    }
    args& operator >> (double& v)
    {
        if( opt && (n >= argc) ) return *this;
        if(!ni()->get_float_value(get(n),&v)) throw error(n,"float");
        n++;
        return *this;
    }
    args& operator >> (std::ustring& v)
    {
        if( opt && (n >= argc) ) return *this;
        const WCHAR* p = 0;
        unsigned l = 0;
    ...
    args& operator >> (optional_e m)
    {
        opt = true;
        return *this;
    }
    // arg "stream" modifier, skip the parameter.
    args& operator >> (skip_e m)
    {
        ++n;
        return *this;
    }
...
struct method_def: public tiscript_method_def
{
    ...
    method_def(const char *n, method_impl* h)
    {
        dispatch = 0, name = n;
        handler = h;
        tag = 0;
...
struct prop_def: public tiscript_prop_def
{
    ...
    prop_def(const char *n, getter_impl* gh, setter_impl* sh)
    {
        dispatch = 0;
        name = n;
        getter = gh;
...
struct const_def: public tiscript_const_def
{
    ...
    const_def(const char *n, int v)
    {
        name = n;
        val.i = v;
        type = TISCRIPT_CONST_INT;
    }
    const_def(const char *n, double v)
    {
        name = n;
        val.f = v;
        type = TISCRIPT_CONST_FLOAT;
    }
    const_def(const char *n, const WCHAR* v)
    {
        name = n;
        val.str = v;
        type = TISCRIPT_CONST_STRING;
    }
};
...
inline void  set_remote_std_streams(HVM vm, pinned& input, pinned& output, pinned& error)
{
    ni()->set_remote_std_streams(vm, &input, &output, &error);
}
...
struct object_enum
{
    ...
    inline static bool TISAPI _enum(VM *vm, value key, value val, void* tag)
    {
        ...
        oe->vm = vm;
        return oe->operator()(key,val);
    }
};
inline bool for_each_prop(HVM vm, value obj, object_enum& cb)
{
    return ni()->for_each_prop(vm, obj, object_enum::_enum, &cb);
}
