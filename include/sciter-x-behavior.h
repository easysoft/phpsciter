...
struct VALUE_PARAMS
{
    ...
    SCITER_VALUE val;
#ifdef __cplusplus
    VALUE_PARAMS(bool do_set)
    {
        methodID = do_set? SET_VALUE : GET_VALUE;
    }
#endif
};
...
struct event_handler
{
    ...
    virtual bool on_draw   (HELEMENT he, UINT draw_type, HGFX hgfx, const RECT& rc )
    {
    ...
    virtual bool on_script_call(HELEMENT he, LPCSTR name, UINT argc, const SCITER_VALUE* argv, SCITER_VALUE& retval)
    {
        return false;
    }
    ...
    virtual bool on_script_call(HELEMENT he, tiscript_VM* pvm, tiscript_value tag, tiscript_value& retval)
    {
        return false;
    }
